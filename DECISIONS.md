...
### 2026-04-14: Single headless runner, not a multi-agent hierarchy
...
### 2026-04-14: data/results.tsv is ground truth, W&B is visualization
Decision: All quantitative results land in `data/results.tsv` as the durable append-only ground truth. W&B mirrors results for visualization and historical comparison.
...
Rationale: Feature creep is the single largest risk to a solo project on a fixed schedule. The proposal was scoped deliberately. Additions happen through a human edit to the YAML.
