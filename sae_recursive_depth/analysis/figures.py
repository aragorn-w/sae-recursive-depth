...
RESULTS_TSV = REPO_ROOT / "data" / "results.tsv"
POSTHOC_TSV = REPO_ROOT / "data" / "pwmcc_posthoc.tsv"
SUMMARY_DIR = REPO_ROOT / "data" / "artifacts" / "_summary"
...
def build_all() -> None:
    ...
    script_path = "sae_recursive_depth/analysis/figures.py"
