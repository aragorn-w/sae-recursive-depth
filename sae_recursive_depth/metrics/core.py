...
- ``variance_explained(recon, target)`` (fraction of variance explained on a
  held-out batch).
- ``dead_latent_fraction(activations)`` (fraction of latents that never
  activate across the provided batch).
"""
