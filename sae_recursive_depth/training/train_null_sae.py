...
Handles rows where `level0_source == "random_gaussian"`. Trains an SAE on
isotropic Gaussian vectors of matching dimensionality and sample count;
feeds the `pwmcc_vs_null_sigma` computation for real-data rows.
...
from sae_recursive_depth.metrics import (
    NULL_SEED_OFFSET,
