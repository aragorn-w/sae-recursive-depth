...
AUXK_TRIGGER_LOG = Path("data/AUXK_TRIGGER.log")
RESULTS_TSV = Path("data/results.tsv")
...
def main():
    ...
    # Gate fires are recorded in data/gates.tsv and
    # state.most_recent_gate_outcome.
